...
public class CAgentMethodVoid4<P1, P2, P3, P4> extends CAgentMethodVoidBase {
	Proc5<Agent, P1, P2, P3, P4> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;

	public CAgentMethodVoid4(Proc5<Agent, P1, P2, P3, P4> f, ClassInfo[] pclazzs) {
		super(pclazzs);_fp = f;
	}

	public CAgentMethodVoid4(CAgentMethodVoid4<P1, P2, P3, P4> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentMethodVoid4<P1, P2, P3, P4>(this);
	}
