...
public class CAgentMethodVoid5<P1, P2, P3, P4, P5> extends CAgentMethodVoidBase {
	Proc6<Agent, P1, P2, P3, P4, P5> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentMethodVoid5(Proc6<Agent, P1, P2, P3, P4, P5> f, ClassInfo[] pclazzs) {
		super(pclazzs);_fp = f;
	}

	public CAgentMethodVoid5(CAgentMethodVoid5<P1, P2, P3, P4, P5> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentMethodVoid5<P1, P2, P3, P4, P5>(this);
	}
