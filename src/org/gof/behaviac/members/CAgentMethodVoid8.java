...
public class CAgentMethodVoid8<P1, P2, P3, P4, P5, P6, P7, P8> extends CAgentMethodVoidBase {
	Proc9<Agent, P1, P2, P3, P4, P5, P6, P7, P8> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public IMethod Clone() {
		return new CAgentMethodVoid8<P1, P2, P3, P4, P5, P6, P7, P8>(this);
	}
