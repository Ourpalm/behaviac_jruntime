...
public class CAgentStaticMethodVoid7<P1, P2, P3, P4, P5, P6, P7> extends CAgentMethodVoidBase {
	Proc7<P1, P2, P3, P4, P5, P6, P7> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentStaticMethodVoid7(Proc7<P1, P2, P3, P4, P5, P6, P7> f, ClassInfo[] pclazzs) {
		super(pclazzs);_fp = f;
	}

	public CAgentStaticMethodVoid7(CAgentStaticMethodVoid7<P1, P2, P3, P4, P5, P6, P7> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentStaticMethodVoid7<P1, P2, P3, P4, P5, P6, P7>(this);
	}
