...
public class CAgentStaticMethodVoid6<P1, P2, P3, P4, P5, P6> extends CAgentMethodVoidBase {
	Proc6<P1, P2, P3, P4, P5, P6> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentStaticMethodVoid6(Proc6<P1, P2, P3, P4, P5, P6> f, ClassInfo[] pclazzs) {
		super(pclazzs);_fp = f;
	}

	public CAgentStaticMethodVoid6(CAgentStaticMethodVoid6<P1, P2, P3, P4, P5, P6> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentStaticMethodVoid6<P1, P2, P3, P4, P5, P6>(this);
	}
