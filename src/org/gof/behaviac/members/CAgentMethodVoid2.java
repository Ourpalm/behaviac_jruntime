...
public class CAgentMethodVoid2<P1, P2> extends CAgentMethodVoidBase {
	Proc3<Agent, P1, P2> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	...
	public CAgentMethodVoid2(CAgentMethodVoid2<P1, P2> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentMethodVoid2<P1, P2>(this);
	}
	...
	public void Run(Agent self) {
		_fp.run(self, (P1) _p1.GetValueObject(self), (P2) _p2.GetValueObject(self));
	}
