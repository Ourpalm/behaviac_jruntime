...
public class CAgentStaticMethod2<R, P1, P2> extends CAgentMethodBase {
	Func2<R, P1, P2> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;

	public CAgentStaticMethod2(Func2<R, P1, P2> f, ClassInfo rclazz, ClassInfo[] pclazzs) {
		super(rclazz, pclazzs);
		_fp = f;
	}

	public CAgentStaticMethod2(CAgentStaticMethod2<R, P1, P2> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentStaticMethod2<R, P1, P2>(this);
	}
