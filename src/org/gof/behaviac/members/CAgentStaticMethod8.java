...
public class CAgentStaticMethod8<R, P1, P2, P3, P4, P5, P6, P7, P8> extends CAgentMethodBase {
	Func8<R, P1, P2, P3, P4, P5, P6, P7, P8> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentStaticMethod8(Func8<R, P1, P2, P3, P4, P5, P6, P7, P8> f, ClassInfo rclazz, ClassInfo[] pclazzs) {
		super(rclazz, pclazzs);
		_fp = f;
	}

	public CAgentStaticMethod8(CAgentStaticMethod8<R, P1, P2, P3, P4, P5, P6, P7, P8> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentStaticMethod8<R, P1, P2, P3, P4, P5, P6, P7, P8>(this);
	}
