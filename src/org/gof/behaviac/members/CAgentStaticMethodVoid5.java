...
public class CAgentStaticMethodVoid5<P1, P2, P3, P4, P5> extends CAgentMethodVoidBase {
	Proc5<P1, P2, P3, P4, P5> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentStaticMethodVoid5(Proc5<P1, P2, P3, P4, P5> f, ClassInfo[] pclazzs) {
		super(pclazzs);_fp = f;
	}

	public CAgentStaticMethodVoid5(CAgentStaticMethodVoid5<P1, P2, P3, P4, P5> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentStaticMethodVoid5<P1, P2, P3, P4, P5>(this);
	}
	...
	public void Run(Agent self) {
		_fp.run((P1) _p1.GetValueObject(self), (P2) _p2.GetValueObject(self), (P3) _p3.GetValueObject(self),
				(P4) _p4.GetValueObject(self), (P5) _p5.GetValueObject(self));
	}
