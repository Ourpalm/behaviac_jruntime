...
public class CAgentStaticMethod7<R, P1, P2, P3, P4, P5, P6, P7> extends CAgentMethodBase {
	Func7<R, P1, P2, P3, P4, P5, P6, P7> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentStaticMethod7(Func7<R, P1, P2, P3, P4, P5, P6, P7> f, ClassInfo rclazz, ClassInfo[] pclazzs) {
		super(rclazz, pclazzs);
		_fp = f;
	}

	public CAgentStaticMethod7(CAgentStaticMethod7<R, P1, P2, P3, P4, P5, P6, P7> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentStaticMethod7<R, P1, P2, P3, P4, P5, P6, P7>(this);
	}
	...
	public void Run(Agent self) {
		_returnValue.value = _fp.run((P1) _p1.GetValueObject(self), (P2) _p2.GetValueObject(self),
				...
				(P6) _p6.GetValueObject(self), (P7) _p7.GetValueObject(self));
	}
