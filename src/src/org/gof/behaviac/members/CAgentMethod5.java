...
public class CAgentMethod5<R, P1, P2, P3, P4, P5> extends CAgentMethodBase {
	Func6<R, Agent, P1, P2, P3, P4, P5> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentMethod5(Func6<R, Agent, P1, P2, P3, P4, P5> f, ClassInfo rclazz, ClassInfo[] pclazzs) {
		super(rclazz, pclazzs);
		_fp = f;
	}

	public CAgentMethod5(CAgentMethod5<R, P1, P2, P3, P4, P5> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentMethod5<R, P1, P2, P3, P4, P5>(this);
	}
