...
public class CAgentStaticMethodVoid8<P1, P2, P3, P4, P5, P6, P7, P8> extends CAgentMethodVoidBase {
	Proc8<P1, P2, P3, P4, P5, P6, P7, P8> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentStaticMethodVoid8(Proc8<P1, P2, P3, P4, P5, P6, P7, P8> f, ClassInfo[] pclazzs) {
		super(pclazzs);_fp = f;
	}

	public CAgentStaticMethodVoid8(CAgentStaticMethodVoid8<P1, P2, P3, P4, P5, P6, P7, P8> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentStaticMethodVoid8<P1, P2, P3, P4, P5, P6, P7, P8>(this);
	}
	...
	public void Run(Agent self) {
		_fp.run((P1) _p1.GetValueObject(self), (P2) _p2.GetValueObject(self), (P3) _p3.GetValueObject(self),
				...
				(P7) _p7.GetValueObject(self), (P8) _p8.GetValueObject(self));
	}
