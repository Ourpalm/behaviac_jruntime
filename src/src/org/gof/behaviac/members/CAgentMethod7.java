...
public class CAgentMethod7<R, P1, P2, P3, P4, P5, P6, P7> extends CAgentMethodBase {
	Func8<R, Agent, P1, P2, P3, P4, P5, P6, P7> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentMethod7(Func8<R, Agent, P1, P2, P3, P4, P5, P6, P7> f, ClassInfo rclazz, ClassInfo[] pclazzs) {
		super(rclazz, pclazzs);
		_fp = f;
	}

	public CAgentMethod7(CAgentMethod7<R, P1, P2, P3, P4, P5, P6, P7> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentMethod7<R, P1, P2, P3, P4, P5, P6, P7>(this);
	}
