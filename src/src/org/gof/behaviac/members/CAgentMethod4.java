...
public class CAgentMethod4<R, P1, P2, P3, P4> extends CAgentMethodBase {
	Func5<R, Agent, P1, P2, P3, P4> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;

	public CAgentMethod4(Func5<R, Agent, P1, P2, P3, P4> f, ClassInfo rclazz, ClassInfo[] pclazzs) {
		super(rclazz, pclazzs);
		_fp = f;
	}

	public CAgentMethod4(CAgentMethod4<R, P1, P2, P3, P4> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentMethod4<R, P1, P2, P3, P4>(this);
	}
