...
public class CAgentMethod6<R, P1, P2, P3, P4, P5, P6> extends CAgentMethodBase {
	Func7<R, Agent, P1, P2, P3, P4, P5, P6> _fp;
	IInstanceMember _p1;
	IInstanceMember _p2;
	IInstanceMember _p3;
	IInstanceMember _p4;
	...
	public CAgentMethod6(Func7<R, Agent, P1, P2, P3, P4, P5, P6> f, ClassInfo rclazz, ClassInfo[] pclazzs) {
		super(rclazz, pclazzs);
		_fp = f;
	}

	public CAgentMethod6(CAgentMethod6<R, P1, P2, P3, P4, P5, P6> rhs) {
		super(rhs);
		_fp = rhs._fp;
		_p1 = rhs._p1;
		_p2 = rhs._p2;
	...
	public IMethod Clone() {
		return new CAgentMethod6<R, P1, P2, P3, P4, P5, P6>(this);
	}
